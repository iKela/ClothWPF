...
{
    public class ClassModelProductEditByExternalIdPromApi
    {
        public string id {get;set; }//Уникальный идентификатор товара в вашей системе учёта товаров (external_id).
