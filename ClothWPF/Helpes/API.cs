...
public class EvoClientExample
{
     ...
     private static String token = "5ea0b000da421084e276e7cdd19119850b61a9f4";  // Your authorization token
     private static String host = "my.prom.ua";  // e.g.: my.prom.ua, my.tiu.ru, my.satu.kz, my.deal.by, my.prom.md
